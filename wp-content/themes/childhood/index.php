    ...
    <div class="glide__track" data-glide-el="track">
        <ul class="glide__slides">
			...
			foreach ( $posts as $post ) {
                ...
                <li style="background-image: url('<?= the_field( 'slider_img' ); ?>')"
                    class="glide__slide">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-7 offset-1">
                                <h2 style="
								<?php if (get_field( 'slider_color') == 'white') { ?> color: #fff; <?php } ?>; "
                                    class="slider__title"><?php the_title(); ?></h2>
	                            <?php if (get_field( 'slider_button') == 'on') { ?>
    ...
    <div class="container">
        ...
        <div class="toys__wrapper">
            ...
            <div class="toys__item"
                 ...
                 } else { echo get_template_directory_uri(). '/assets/img/not-found.jpg';} ?>');">
    ...
    <div class="container">
        ...
        ?>
            <div class="row" <?php if($key % 2 !== 0) {?> style="flex-direction: row-reverse;" <?php } ?> >
                ...
                <div class="col-lg-6">
                    <img class="aboutus__img" src="<?php if (has_post_thumbnail()){ the_post_thumbnail_url();
                    } else { echo get_template_directory_uri(). '/assets/img/not-found.jpg';} ?>" alt="мир детства">
                </div>
            </div>
                    ...
                    <div class="contacts__phones">
                        <div class="contacts__phoneblock">
                            ...
                            <div class="contacts__phonewrap">
                                ...
                                <a href="tel:<?= the_field( 'tel', 2 ); ?>"><?= the_field( 'tel', 2 ); ?></a>
                            </div>
                        </div>
						<?php if ( get_field( 'tel_2', 2 ) ) { ?>
                            <div class="contacts__phoneblock">
                                Телефон №2
                                <div class="contacts__phonewrap">
                                    <svg width="19" height="19" viewBox="0 0 19 19" fill="none"
                                        ...
                                        <path d="M2.85352 2.08057C2.7297 1.95675 2.52956 1.95675 2.40574 2.08057C1.89432 2.59168 1.61279 3.27253 1.61279 3.99708C1.61279 4.72163 1.89432 5.40247 2.40574 5.9139C2.4675 5.97565 2.54856 6.00669 2.62963 6.00669C2.7107 6.00669 2.79177 5.97565 2.85352 5.9139C2.97734 5.79008 2.97734 5.58995 2.85352 5.46613C2.4618 5.0744 2.24614 4.55252 2.24614 3.99708C2.24614 3.44163 2.46148 2.92007 2.85352 2.52834C2.97702 2.40484 2.97702 2.20439 2.85352 2.08057Z"
                                              fill="url(#paint7_linear)"/>
                                        <defs>
                                            <linearGradient id="paint0_linear" x1="9.50016" y1="0.000305176"
                                                            x2="9.50016"
                                                            y2="19.0007" gradientUnits="userSpaceOnUse">
                                                <stop stop-color="#1C609E"/>
                                                <stop offset="1" stop-color="#1C609E"/>
...
echo apply_filters( 'my_filter', 'Wolrd', 15 );
